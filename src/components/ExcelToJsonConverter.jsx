                    ...
                    try {
                        ...
                        const formattedData = parsedData.map((row, index) => {
                            ...
                            return {
                                ...
                                tags: normalizedRow["tags"] ? normalizedRow["tags"].split(",") : [],
                                keyFeatures: normalizedRow["keyfeatures"] ? normalizedRow["keyfeatures"].split(",") : [],
                                actionWords: normalizedRow["actionwords"] ? normalizedRow["actionwords"].split(",") : [],
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    {conversionStatus === 'success' ? 'Conversion successful!' :
