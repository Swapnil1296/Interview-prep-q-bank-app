export const javascriptQuestionData = [
  ...
  },
  {
    ...
    tags: ["fundamental"],
    keyFeatures: [],
    actionWords: ["instruction execute directly without prior compilation."],
    codeExample: "",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    tags: ["operators"],
    keyFeatures: [],
    actionWords: ["equal in value and of the same data type"],
    codeExample: "",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    tags: ["variables"],
    keyFeatures: [],
    actionWords: ["variables can hold values of different data types"],
    codeExample: "",
  },
  {
    id: 16,
  ...
  },
  {
    ...
    tags: ["event"],
    keyFeatures: [],
    actionWords: ["Propogation of triggered event to its parent elements."],
    codeExample: "",
  },
  {
    id: 20,
  ...
  },
  {
    ...
    topic: "javascript",
    question:
      "What is Deferred Script & Describe the role of deferred scripts in JS .",
    answer:
  ...
  },
  {
    ...
    tags: ["data-types"],
    keyFeatures: [],
    actionWords: ["absence of any object value"],
    codeExample: "",
  },
  {
    id: 25,
  ...
  },
  {
    ...
    tags: ["closure"],
    keyFeatures: [],
    actionWords: ["combination of function & lexical environment", "\n"],
    codeExample:
  ...
  },
  {
    ...
    tags: ["fuction"],
    keyFeatures: [],
    actionWords: ["either takes/returns a function"],
    codeExample:
  ...
  },
  {
    ...
    answer:
      "Classes in JavaScript are a blueprint for creating objects, introduced in ES6 as a more familiar and cleaner syntax for implementing object-oriented programming. While JavaScript is inherently prototype-based, classes provide a more conventional structure for defining object constructors and methods.\nClasses offer a cleaner, more concise syntax over traditional prototype-based inheritance, making the code more readable and organized.\n",
    tags: ["es6"],
    keyFeatures: [],
    actionWords: [],
    codeExample:
  ...
  },
  {
    ...
    answer:
      "A Proxy object acts as a wrapper or intermediary for another object (called the target), allowing you to intercept and redefine fundamental operations like property lookup, assignment, enumeration, and function invocation.",
    tags: ["object"],
    keyFeatures: [],
    actionWords: [
  ...
  },
  {
    ...
    tags: ["object"],
    keyFeatures: [],
    actionWords: ["Immutable properties/no change", " changes can be made"],
    codeExample: "",
  },
  {
    id: 54,
    ...
    tags: ["fundamental"],
    keyFeatures: [],
    actionWords: ["track of function calls"],
    codeExample: "",
  },
  {
    id: 55,
  ...
  },
  {
    ...
    tags: ["arrays"],
    keyFeatures: [],
    actionWords: ["contains only  primitive values", ""],
    codeExample: "",
  },
  {
    id: 61,
  ...
  },
  {
    ...
    tags: ["fuction"],
    keyFeatures: [],
    actionWords: ["anonymous function or arrow function"],
    codeExample: "",
  },
  {
    id: 71,
