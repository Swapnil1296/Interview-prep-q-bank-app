export const reactQuesionData =[
  ...
  },
  {
    ...
    "answer": "A Single Page Application (SPA) is a type of web application that interacts with the user by dynamically rewriting the current page rather than loading entire new pages from the server. This approach provides a more fluid and responsive user experience, similar to a desktop application. ",
    "tags": [
      "fundamental"
    ],
    "keyFeatures": [],
