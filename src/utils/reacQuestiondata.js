export const reactQuesionData =[
  ...
  },
  {
    ...
    "answer": "A Single Page Application (SPA) is a type of web application that <mark>interacts with the user by dynamically rewriting the current page rather than loading entire new pages from the server</mark> . This approach provides a more fluid and responsive user experience, similar to a desktop application. ",
    "tags": [
      "SPA"
    ],
    "keyFeatures": [],
    "actionWords": [
      "dynamic rewriting of current page.","provides fluid and responsive user experience"
    ],
    "codeExample": ""
  },
  {
  ...
  },
  {
    ...
    "actionWords": [
      ...
      "immutable","enforce a unidirectional data flow"
    ],
    "codeExample": ""
  },
  {
  ...
  },
  {
    ...
    "actionWords": [
      ...
      " performance optimization","diffing","Reconciliation"
    ],
  ...
  },
  {
    ...
    "answer": "In general, browsers are not capable of reading  JSX and only can read pure JavaScript. The web browsers read  JSX with the help of a transpiler. \nTranspilers are used to convert  into JavaScript. The transpiler used is called Babel",
    "tags": [
      "JSX"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "The useReducer hook is a powerful tool for managing complex state logic in React functional components. It provides a more structured approach to state management, making it easier to handle state transitions and maintain predictable state changes.",
    "tags": [
      "hooks"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": " Context provides a way to pass data through the component tree without having to pass props down manually at every level. This is particularly useful for globally accessible data, such as theme settings, user authentication, and application settings.",
    "tags": [
      "hooks"
    ],
    "keyFeatures": [],
    ...
    "codeExample": "Creating the Context:\n// ThemeContext.\r\nimport React from 'react';\r\n\r\nconst ThemeContext = React.createContext('light'); // 'light' is the default value\r\n\r\nexport default ThemeContext;\n\r\nProviding the Context Value:\n// App.\r\nimport React, { useState } from 'react';\r\nimport ThemeContext from './ThemeContext';\r\nimport ThemedComponent from './ThemedComponent';\r\n\r\nfunction App() {\r\n  const [theme, setTheme] = useState('light');\r\n\r\n  return (\r\n    <ThemeContext.Provider value={theme}>\r\n      <div>\r\n        <button onClick={() => setTheme(theme === 'light' ? 'dark' : 'light')}>\r\n          Toggle Theme\r\n        </button>\r\n        <ThemedComponent />\r\n      </div>\r\n    </ThemeContext.Provider>\r\n  );\r\n}\r\n\r\nexport default App;\r\n\nConsuming the Context Value:\n\n// ThemedComponent.\r\nimport React, { useContext } from 'react';\r\nimport ThemeContext from './ThemeContext';\r\n\r\nfunction ThemedComponent() {\r\n  // useContext accesses the current context value for ThemeContext\r\n  const theme = useContext(ThemeContext);\r\n\r\n  const style = {\r\n    padding: '20px',\r\n    background: theme === 'light' ? 'f0f0f0' : '333',\r\n    color: theme === 'light' ? '333' : 'f0f0f0',\r\n    textAlign: 'center'\r\n  };\r\n\r\n  return <div style={style}>The current theme is {theme}</div>;\r\n}\r\n\r\nexport default ThemedComponent;\r\n\n"
  },
  {
    "id": 38,
    "topic": "reactJs",
    "question": "Explain the useRef hook in React?",
    "answer": "The useRef hook is a React hook that provides a way to access and interact with DOM elements directly, as well as to persist values between renders without causing a re-render. It is similar to useState, but it does not trigger a re-render when the value it holds changes.",
    "tags": [
      "hooks"
    ],
    "keyFeatures": [],
    "actionWords": [
      "a way to access and interact with DOM elements directly"
    ],
    "codeExample": ""
  },
  {
  ...
  },
  {
    ...
    "answer": "The useCallback hook in React is used to memoize functions. It returns a memoized version of the callback function that only changes if one of the dependencies has changed. This can be useful for optimizing performance, especially when passing callbacks to child components that rely on referential equality to prevent unnecessary renders.",
    "tags": [
      "hooks"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "A provider is used to provide context to the whole application whereas a consumer consume the context provided by nearest provider. In other words The Provider acts as a parent it passes the state to its children whereas the Consumer uses the state that has been passed. ",
    "tags": [
      "context"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Keyed Fragments in React are a way to group multiple elements without adding extra nodes to the DOM, and they help React identify which items have changed, been added, or removed. This is particularly useful when rendering lists of elements where React needs to track each element's identity.",
    "tags": [
      "fragment"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Stale state occurs in React when a component holds or uses an outdated version of a state value because it hasn't been updated to reflect the latest changes. This can lead to unexpected behaviors and bugs, especially in asynchronous scenarios or when relying on closures.",
    "tags": [
      "state"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "React app tree shaking refers to the process of eliminating dead code or unused modules from the final bundled JavaScript file during the build process. Tree shaking is a common optimization technique used by modern JavaScript bundlers like Webpack or Rollup to reduce the size of the final bundle, thus improving loading times and runtime performance.",
    "tags": [
      "optimization"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Styled-component is a Module which allows us to write CSS within JavaScript in a very modular and reusable way in React. Instead of having one global CSS file for a React project, we can use styled-component for enhancing the developer experience. It also removes the mapping between components and styles – using components as a low-level styling construct",
    "tags": [
      "components"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Loadable components are a pattern and a set of libraries that enable dynamic code splitting and lazy loading of components in React applications. This technique allows you to split your application into smaller chunks and load them asynchronously only when they are needed, improving performance by reducing the initial bundle size.\nWith Loadable Components, you can load React components asynchronously, meaning the component code won't be loaded until it's actually needed. This is particularly useful for large React apps where you don't need all the components immediately when the app starts.",
    "tags": [
      "components"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Default props in React are values that you assign to a component's props when no value is provided by the parent component. They help ensure that a component has a fallback value for its props in case the parent component doesn't pass any value for a specific prop.\n\nIn simpler terms, default props are like a \"backup\" for your component's props, ensuring it has a meaningful value even if nothing is provided.\n\n\n",
    "tags": [
      "props"
    ],
    "keyFeatures": [],
    "actionWords": [
      "value assigned to props when no vlaue is provided"
    ],
  ...
  },
  {
    ...
    "answer": "Route-based code splitting is a technique used in React applications to dynamically load JavaScript code specific to each route or page of the application. Instead of loading all JavaScript code upfront when the application is initially loaded, route-based code splitting allows you to split the code into smaller bundles and load them asynchronously only when navigating to a particular route.",
    "tags": [
      "optimization"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "In React, the render() method is used to define what should be rendered to the DOM. It is a core method in class components, responsible for returning the JSX (or React elements) that will be displayed on the screen. The render() method must return a single React element, which can be a JSX element, a component, or null.",
    "tags": [
      "rendering"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "Conditional rendering in React is a technique for rendering different components or elements based on certain conditions. \nThis allows developers to dynamically control the output of the component based on the application's state or props.",
    "tags": [
      "rendering"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "No, currently React.lazy function supports default exports only. If you would like to import modules which are named exports, you can create an intermediate module that reexports it as the default. It also ensures that tree shaking keeps working and don’t pull unused components. Let's take a component file which exports multiple named components,",
    "tags": [
      "optimization"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": " This is because class is a reserved keyword in JavaScript, used to define classes in object-oriented programming. Since React components are written in JavaScript, using class as an attribute name would conflict with the JavaScript keyword.\n",
    "tags": [
      "fundamental"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "The react-dom package provides DOM-specific methods that can be used at the top level of your app. Most of the components are not required to use this module",
    "tags": [
      "fundamental"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "answer": "The dangerouslySetInnerHTML attribute is React's replacement for using innerHTML in the browser DOM. Just like innerHTML, it is risky to use this attribute considering cross-site scripting (XSS) attacks. You just need to pass a __  object as key and HTML text as value.\n\n",
    "tags": [
      "fundamental"
    ],
    "keyFeatures": [],
    "actionWords": [],
    "codeExample": "function createMarkup() {\n  return { __ : \"First &middot; Second\" };\n}\n\nfunction MyComponent() {\n  return <div dangerouslySetInnerHTML={createMarkup()} />;\n}"
  },
  {
    "id": 101,
    "topic": "reactJs",
  ...
  },
  {
    ...
    "answer": "The React philosophy is that props should be immutable(read only) and top-down. This means that a parent can send any prop values to a child, but the child can't modify received props.",
    "tags": [
      "props"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "keyFeatures": [],
    "actionWords": [],
    "codeExample": "getUserProfile = (user) => {\n  const latestAddress = user.address;\n  this.setState((state) => {\n    if (state.address === latestAddress) {\n      return null;\n    } else {\n      return { title: latestAddress };\n    }\n  });\n};"
  },
  {
    "id": 108,
    "topic": "reactJs",
  ...
  },
  {
    ...
    "answer": "Capture phase events are a part of the event propagation model in the Document Object Model (DOM) of web browsers. In this model, when an event occurs on an element, such as a click or a keypress, it doesn't just affect that element; it also affects its parent elements in the DOM hierarchy. Event propagation allows events to \"bubble\" up from the target element to its ancestors in the DOM tree or \"capture\" down from the top of the tree to the target element.\nThe onClickCapture React event is helpful to catch all the events of child elements irrespective of event propagation logic or even if the events propagation stopped. This is useful if you need to log every click events for analytics purpose.",
    "tags": [
      "fundamental"
    ],
    "keyFeatures": [],
    "actionWords": [
      "part of event propagation model",
      " captures event"
    ],
    "codeExample": ""
  },
