export const reactQuesionData = [
  ...
  },
  {
    ...
    "answer": "If you're using an empty dependency array, the API call will not run during the updating phase—it only runs after the initial mounting. However, if you provide dependencies, the effect can run after updates when those dependencies change",
    "tags": ["useEffect",
      "hooks"
    ],
    "keyFeatures": [],
  ...
  },
  {
    ...
    "keyFeatures": [],
    "actionWords": [
      " 1. Use a Proxy Server\n\nDevelopment Proxy:  \n- Create React App:  \n  Add a \"proxy\" field in your package.on to forward API requests to the backend server.\n  \n  // package.on\n  {\n    \"name\": \"my-app\"",
      "\n    \"version\": \"0.1.0\"",
      "\n    \"proxy\": \"http://localhost:5000\"",
      "\n    ...\n  }\n  \n  This way",
      " requests from your frontend (running on a different port) are proxied to your API server",
      " bypassing CORS issues in development.\n\n- Webpack Dev Server:  \n  Configure a proxy in your webpack dev server configuration:\n  \n  // webpack.config.\n  module.exports = {\n    devServer: {\n      proxy: {\n        '/api': 'http://localhost:5000'\n      }\n    }\n  };\n  \n\n\n\n 2. Use a CORS Proxy Service\n\nFor quick testing or prototyping",
      " you might use a public CORS proxy (e.g.",
      " https://cors-anywhere.herokuapp.com/). However",
      " be cautious—this is not recommended for production due to security and performance concerns.\n\n\nfetch('https://cors-anywhere.herokuapp.com/http://example.com/api/data')\n  .then(response => response.on())\n  .then(data => console.log(data))\n  .catch(err => console.error(err));\n\n\n\n\n 3. Browser Extensions (Development Only)\n\nInstall a browser extension that disables CORS enforcement during development. This is useful for testing",
      " but should never be used in production because it compromises browser security.\n\n- Example: \"Moesif Origin & CORS Changer\" for Chrome or similar tools.\n\n\n\n 4. JSONP (For GET Requests Only)\n\nIf you’re only performing GET requests and the API supports it",
      " you might use JSONP (JSON with Padding) as a workaround. However",
      " this approach is limited to GET requests and is considered outdated."
    ],
    "codeExample": ""
  },
  {
